...
# create 'my_subject' data set
my_subject_data <- rbind(my_subject_train, my_subject_test)
...
# correct column name
names(my_subject_data) <- "subject"

# bind all the data in a single data set
total_data <- cbind(x_data, y_data, my_subject_data)
...
write.table(averages_data, "output_averages_data.txt", row.name=FALSE)